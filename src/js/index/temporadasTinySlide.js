...
function selectSesion(seasionSelec) {
    ...
    let seasion = {
        um: {
            episode: {
                um: {
                    imgSrc: "./src/img/Breaking-Bad.png",
                    tituloImg: "Episode 1",
                },
                dois: {
                    imgSrc: "./src/img/Breaking-Bad.png",
    ...
    <div class="episode">
        <div class="episode-container-main">
            <div class="episode-container">
                <img class="episode_capa" src="./src/img/breaking-Bad.png" alt="Capa temporada 1">
